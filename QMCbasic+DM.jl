...
pkgtry.(["Jacobi", "DelimitedFiles", "Plots", "Interpolations", "Optim"]);
using Jacobi, DelimitedFiles, Plots, Interpolations, Optim
...
function dark(nX)
    ...
    free=integ(kf(nX),mX)
    boson=GV*nX^2/2
    return cte*free + boson
end

function H(nn,np,nΛ,nΞ0,nΞm,nX,ne,nμ,gsig,gdel,gomg,grho)
    (S,D)=σδ(nn,np,nΛ,nΞ0,nΞm,gsig,gdel)
    MeanFields=mσ^2*S^2/2 + (λ3/6)*(gsig*S)^3 + mδ^2*D^2/2 + mρ^2*ρ(nn,np,nΛ,nΞ0,nΞm,grho)^2/2 + mω^2*ω(nn,np,nΛ,nΞ0,nΞm,gomg)^2/2
    return H0(nn,np,nΛ,nΞ0,nΞm,ne,nμ,gsig,gdel)+Fock(nn,np,nΛ,nΞ0,nΞm,gsig,gdel,gomg,grho)+Fockπ(nn,np,nΛ,nΞ0,nΞm)+MeanFields+overlap(nn,np,nΛ,nΞ0,nΞm) + dark(nX)
end
...
H(0.16*fmm3/2,0.16*fmm3/2,0,0,0,0,0,0,stdgsig,stdgdel,stdgomg,stdgrho)/mevpfm3

nrange=collect(0.0:dens_step:1.0fmm3)
@time htemp=H.(nrange/2,nrange/2,0,0,0,0,0,0,stdgsig,stdgdel,stdgomg,stdgrho)./mevpfm3
plot(nrange,htemp)
...
function NMparameters(gsig,gdel,gomg,grho)
    ℰfit(n)=H(n/2,n/2,0,0,0,0,0,0,gsig,gdel,gomg,grho)/n-mn
    dEfit(x)=d1f(ℰfit,x,0.001fmm3)
    Sfit(n)=(H(n,0,0,0,0,0,0,0,gsig,gdel,gomg,grho)-H(n/2,n/2,0,0,0,0,0,0,gsig,gdel,gomg,grho))/n
...
H(0.17*fmm3/2,0.17*fmm3/2,0,0,0,0,0,0,fitresult...)/mevpfm3

######################################################################
# Defining Chemical Potential and Pressure

function chempot(Index,N)
    (nn,np,nΛ,nΞ0,nΞm,nX,ne,nμ)=N
    function l(x)
        d=zeros(length(N))
        d[Index]=x-N[Index]
        return d
...
μn(nn,np,nΛ,nΞ0,nΞm,nX,ne,nμ)=chempot(1,[nn,np,nΛ,nΞ0,nΞm,nX,ne,nμ])
μp(nn,np,nΛ,nΞ0,nΞm,nX,ne,nμ)=chempot(2,[nn,np,nΛ,nΞ0,nΞm,nX,ne,nμ])
μΛ(nn,np,nΛ,nΞ0,nΞm,nX,ne,nμ)=chempot(3,[nn,np,nΛ,nΞ0,nΞm,nX,ne,nμ])
μΞ0(nn,np,nΛ,nΞ0,nΞm,nX,ne,nμ)=chempot(4,[nn,np,nΛ,nΞ0,nΞm,nX,ne,nμ])
μΞm(nn,np,nΛ,nΞ0,nΞm,nX,ne,nμ)=chempot(5,[nn,np,nΛ,nΞ0,nΞm,nX,ne,nμ])
μX(nn,np,nΛ,nΞ0,nΞm,nX,ne,nμ)=chempot(6,[nn,np,nΛ,nΞ0,nΞm,nX,ne,nμ])
μe(nn,np,nΛ,nΞ0,nΞm,nX,ne,nμ)=chempot(7,[nn,np,nΛ,nΞ0,nΞm,nX,ne,nμ])
μμ(nn,np,nΛ,nΞ0,nΞm,nX,ne,nμ)=chempot(8,[nn,np,nΛ,nΞ0,nΞm,nX,ne,nμ])

function P(nn,np,nΛ,nΞ0,nΞm,nX,ne,nμ)
    p=nn*μn(nn,np,nΛ,nΞ0,nΞm,nX,ne,nμ)
    p=p+np*μp(nn,np,nΛ,nΞ0,nΞm,nX,ne,nμ)
    p=p+nΛ*μΛ(nn,np,nΛ,nΞ0,nΞm,nX,ne,nμ)
    p=p+nΞ0*μΞ0(nn,np,nΛ,nΞ0,nΞm,nX,ne,nμ)
    p=p+nΞm*μΞm(nn,np,nΛ,nΞ0,nΞm,nX,ne,nμ)
    p=p+ne*μe(nn,np,nΛ,nΞ0,nΞm,nX,ne,nμ)
    p=p+nμ*μμ(nn,np,nΛ,nΞ0,nΞm,nX,ne,nμ)
    p=p+nX*μX(nn,np,nΛ,nΞ0,nΞm,nX,ne,nμ)
    p=p-H(nn,np,nΛ,nΞ0,nΞm,nX,ne,nμ,fitresult...)
    return p
end
...
function β(nb,x0=zeros(4).+0.01fmm3)
    function eliminated(nb2,ne,nΛ,nΞ0,nΞm)
        ...
        return H(nn,np,nΛ,nΞ0,nΞm,0.0,ne,nμ,fitresult...)
    end
    ...
    return [βnn,βnp,βnΛ,βnΞ0,βnΞm,0.0,βne,βnμ],[βne,βnΛ,βnΞ0,βnΞm],velim([βne,βnΛ,βnΞ0,βnΞm])
end

function βnohyp(nb,x0=zeros(1).+1e-1fmm3)
    function eliminated(ne)
        (ne)=cut(ne)
        nμ=real(sqrt(kf(ne)^2+me^2-mμ^2 +0.0*im))^3 /(3π^2)
        np=ne+nμ
        nn=cut(nb-(np))
        return H(nn,np,0.0,0.0,0.0,0.0,ne,nμ,fitresult...)
    end
    velim(N)=eliminated(N...)
    opt=optimize(velim,x0.+1e-2fmm3,Newton(),Optim.Options(g_tol=1e-8))
    (βne)=cut(opt.minimizer[1])
    βne=cut(βne)
    βnμ=real(sqrt(kf(βne)^2+me^2-mμ^2 +0.0*im))^3 /(3π^2)
    βnp=βne+βnμ
    βnn=cut(nb-(βnp))
    return [βnn,βnp,0.0,0.0,0.0,0.0,βne,βnμ],[βne],velim([βne])
end
...
plot()
labels=["n","p","Λ","Ξ⁰","Ξ⁻","X","e","μ"]
ntot=nrange.+Btab[:,6]
for i in 1:8
    plot!(nrange,Btab[:,i]./(ntot).+1e-4,label=labels[i],yaxis=:log)
end
plot!(xaxis=[0,1],yaxis=[1e-4,1e0],xlabel="n\$_b\$",ylabel="Density Fraction",guidefontsize=8,title_location=:left,frame=:box,size=(600,300))
...
sk1=readdlm("../../OtherEoSs/RG(SLY4)/eos.table");
#           1  temperature T                                      [MeV]
#           2  baryon number density n_b                          [fm^-3]
#           3  hadronic charge fraction Y_q                       []
#           4  pressure p                                         [MeV fm^-3]
#           5  energy density epsilon                       [MeV/fm^3]
#           6  number fraction Y of particle with index                         10
#           7  number fraction Y of particle with index                         11
#           8  number fraction Y of particle with index                          0
#           9  number fraction Y of particle with index                          1
sk1eos=hcat(sk1[:,5],
            sk1[:,4],
            sk1[:,6].*sk1[:,2],
            sk1[:,7].*sk1[:,2],
...
sk2=readdlm("../../OtherEoSs/RG(SK272)/eos.table")
#           1  temperature T                                      [MeV]        
#           2  baryon number density n_b                          [fm^-3]      
#           3  hadronic charge fraction Y_q                       []           
#           4  pressure p                                         [MeV fm^-3]  
...
ddh=readdlm("../../OtherEoSs/DDhð/eos.table")
#           1  temperature T                                      [MeV]
#           2  baryon number density n_b                          [fm^-3]
#           3  hadronic charge fraction Y_q                       []
#           4  pressure p                                         [MeV fm^-3]
